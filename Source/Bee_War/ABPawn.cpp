...
AABPawn::AABPawn()
{
	...
	Mesh->SetRelativeLocationAndRotation(FVector(0.0f, 0.0f, 70.0f), FRotator(0.0f, -90.0f, 0.0f));//-16.0f z값
	

	SpringArm->TargetArmLength = 400.0f;
	SpringArm->SetRelativeLocation(FVector(0.0f, 0.0f, 120.0f));//70.0f z값
